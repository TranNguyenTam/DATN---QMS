...
import "./TiviVienPhi.scss";

const MODULE_KEY = "vienPhi";
      ...
      <div className="tivi-body">
        ...
        <div className="right-panel">
          ...
          <div style={{ textAlign: "center", marginTop: 12 }}>
            <WaitTimeBadge hangDoiId={Number(effectiveInfo?.HangDoi?.FieldCode)} variant="tivi" />
          </div>
